 ...
 * @extends PIXI.Filter
 */
class Filter extends pixi_js.Filter
{
    /** @override */
    ...
    {
        return pixi_js.Filter.defaultFragmentSrc;
    }
...
Filter.BaseFilter = pixi_js.Filter;

const defaultScale = new pixi_js.Point(1, 1);
...
class FilterScope
{
    constructor()
    {
         ...
         * @private
         */
        this.outputFrame = new pixi_js.Rectangle();
         ...
         * @private
         */
        this.textureDimensions = new pixi_js.Point();
         ...
         * screen.
         */
        this.texturePixels = new pixi_js.Point();
    ...
    {
        return new pixi_js.Rectangle(0, 0, this.textureDimensions.x, this.textureDimensions.y);
    }
...
class RescaleFilter extends Filter
{
    constructor()
    {
        ...
        this.scaleMode = pixi_js.SCALE_MODES.LINEAR;
    }
 ...
 */
class FilterSystem extends pixi_js.systems.FilterSystem
{
    constructor(renderer, ...args)
    {
        ...
        this.globalUniforms.uniforms.inputFrame = new pixi_js.Rectangle();
    ...
    push(target, filters, options = target.filterOptions ? target.filterOptions : {})
    {
        ...
        if (state.filters.length > 0)
        {
            ...
            renderer.renderTexture.bind(state.renderTexture, state.inputFrame,
                new pixi_js.Rectangle(0, 0, state.inputFrame.width, state.inputFrame.height));
    ...
    applyFilter(filter, input, output, clear, options = this.resolveRenderOptions(filter.renderOptions, this.activeState))
    {
        ...
        if (options.geometry)
        {
            ...
            renderer.geometry.draw(options.drawMode ? options.drawMode : pixi_js.DRAW_MODES.TRIANGLE_STRIP);
        }
        else if (filter.legacy)
        {
            ...
            renderer.geometry.draw(pixi_js.DRAW_MODES.TRIANGLES);
        }
        else
        {
            renderer.geometry.bind(this.quad);
            renderer.geometry.draw(pixi_js.DRAW_MODES.TRIANGLE_STRIP);
        }
    }
    ...
    _newGeometry()
    {
        return FilterSystem.geometryPool.pop() || new pixi_js.Geometry();
    }
...
class FilterPipe
{
    ...
    getBridgeTexture(frame)
    {
        ...
        if (this.bridgeTextureOptions)
        {
            ...
            {
                bridgeTexture.scaleMode = pixi_js.SCALE_MODES.LINEAR;
            }
        }
...
exports.FILTER_RECTS = FILTER_RECTS;
exports.Filter = Filter;
exports.FilterPass = FilterPass;
exports.FilterPipe = FilterPipe;
exports.FilterScope = FilterScope;
exports.default = Filter;
exports.injectEF = injectEF;
//# sourceMappingURL=phase-filter-manager.cjs.map
